...
class YoloDetect():
    def __init__(self, detect_class="person", frame_width=(1280), frame_height=(400)):
    #def __init__(self, detect_class="person", frame_width=400, frame_height=200):
        # Paremeters
    ...
    def get_output_layers(self):
        ...
        return self.output_layers  # có thể bỏ dòng này
    ...
    def alert(self, img):
        ...
        # New thead to send telegram after 15 seconds
